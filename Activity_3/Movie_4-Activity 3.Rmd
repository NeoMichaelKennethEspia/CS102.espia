...
url_template <- 'https://www.imdb.com/title/tt0080684/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Star Wars: Episode V - The Empire Strikes Back
", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_4-Activity 3.csv", row.names = FALSE)
```
