...
url_template <- 'https://www.imdb.com/title/tt0167260/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("The Lord of the Rings: The Return of the King
", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_3-Activity 3.csv", row.names = FALSE)
```
