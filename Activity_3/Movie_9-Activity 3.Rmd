...
url_template <- 'https://www.imdb.com/title/tt0056058/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Harakiri", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_9-Activity 3.csv", row.names = FALSE)
```
