...
url_template <- 'https://www.imdb.com/title/tt0253474/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("The Pianist", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_7-Activity 3.csv", row.names = FALSE)
```
