...
url_template <- 'https://www.imdb.com/title/tt0076759/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Star Wars: Episode IV - A New Hope
", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_5-Activity 3.csv", row.names = FALSE)
```
