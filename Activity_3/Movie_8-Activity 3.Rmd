...
url_template <- 'https://www.imdb.com/title/tt0172495/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Gladiator", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_8-Activity 3.csv", row.names = FALSE)
```
