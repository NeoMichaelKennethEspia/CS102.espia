...
url_template <- 'https://www.imdb.com/title/tt0468569/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("The Dark Knight", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_2-Activity 3.csv", row.names = FALSE)
```
